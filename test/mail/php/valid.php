<?php
    ...
    if (isset($_POST['step1']) ) {
        if(empty($_POST['step1']) && STEP1ISREQUIRED) {
            ...
            if (!empty($_POST['step1'])) {
                $step1 = "<b>Куда: </b> " . trim(strip_tags($_POST['step1'])) . "<br>";
            }
        }
    }
    ...
    if (isset($_POST['step2']) ) {
        if(empty($_POST['step2']) && STEP1ISREQUIRED) {
            ...
            if (!empty($_POST['step2'])) {
                $step2 = "<b>Находится: </b> " . trim(strip_tags($_POST['step2'])) . "<br>";
            }
        }
    }
    ...
    if (isset($_POST['step3']) ) {
        if(empty($_POST['step3']) && STEP1ISREQUIRED) {
            ...
            if (!empty($_POST['step3'])) {
                $step3 = "<b>Цвет: </b> " . trim(strip_tags($_POST['step3'])) . "<br>";
            }
        }
    }
    ...
    if (isset($_POST['step4']) ) {
        if(empty($_POST['step4']) && STEP1ISREQUIRED) {
            ...
            if (!empty($_POST['step4'])) {
                $step4 = "<b>Количество окон: </b> " . trim(strip_tags($_POST['step4'])) . "<br>";
            }
        }
    }
    ...
    if (isset($_POST['step5']) ) {
        if(empty($_POST['step5']) && STEP1ISREQUIRED) {
            ...
            if (!empty($_POST['step5']) && is_array($_POST["step5"])) {
                $step5 = "<b>Дополнительные опции: </b> " . implode(", ", $_POST["step5"]) . "<br>";
            }
        }
    }
